...
<div id="ML_window" style="display:none;">
	<div style="width:526px; float:left;"></div>
	<div id="ML_container" style="width:526px; float:left;"><!-- ML_container : S -->
		<div class="ML_lnb" style="display:inline-block;">
		    <div class="ML_lnb_area">
		      <ul>
		          <li class="ML_cert_share sel"><a href="#" id="ML_lnb_share"><span>공동<br>인증서</span></a></li>
		          <li class="ML_cert_finance"><a href="#" id="ML_lnb_finance"><span>금융<br>인증서</span></a></li>
		          <!-- <li class="ML_cert_cloud dis"><a href="#" id="ML_lnb_cloud"><span>클라우드<br>인증서</span></a></li> -->
		      </ul>
		    </div>
	  	</div>
		<div class="ML_content" style="display:inline-block;width:418px;"><!-- ML_content : S -->
