				...
				releaseDialog : function(callback) {
					...
					try{
						...
						if (typeof(onclick) == "function") {
							...
							console.log("releaseDialog error... onclick is not function");
						}	
					}catch(e){
...
//						htmlTxt += '						<tr><td></td><td></td></tr>';
						...
						htmlTxt += '			</span>';
						htmlTxt += '			<span id="span_filefile" class="ML_cert_file_btn_fcs">';
						htmlTxt += '				<input type="file" id="filefile2" accept=".cer,.der,.key,.pfx,.p12" multiple="multiple" class="ML_cert_file_add" onFocus="focusPfxFileObj(\'open\');" onBlur="focusPfxFileObj(\'close\');" tabindex="0" title="파일찾기" />';
						htmlTxt += '			</span>';
						htmlTxt += '		</div>';
						htmlTxt += '		<div class="ML_cert_pw_area">';
						...
						htmlTxt += '				<input type="password" class="passwd_input" title="'+$.i18n.prop("TS038")+'"  placeholder="'+$.i18n.prop("ES042")+'" id="add_browser_password" name="add_browser_password" onClick="initKeyPad();" ds-kb-type="qwerty" ds-kb-focus="true" ds-kb-xy="[-100, 0]" data-tk-kbdType="qwerty" autocomplete="off" value="" onKeypress="DSDialog.enterKeyEvent(event)" npkencrypt="on" data-keypad-type="alpha" data-keypad-theme="default" data-keypad-useyn-type="toggle" data-keypad-useyn-input="addbrowserKeyboardOn">';
						htmlTxt += '			</span>';
